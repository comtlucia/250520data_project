...
summary = "📌 인구 분석 요약: "
if elderly_ratio >= 25:
    summary += "고령 인구 비중이 높아 복지와 건강 인프라 확충이 중요합니다."
elif youth_ratio >= 30:
    summary += "청년층 중심의 지역으로 일자리, 주거, 문화 공간 수요가 큽니다."
elif under20_ratio >= 25:
    summary += "어린이와 청소년이 많아 교육과 안전한 생활환경 조성이 필요합니다."
elif middle_ratio >= 35:
    summary += "중장년층 중심 지역으로 평생교육과 커뮤니티 공간 수요가 큽니다."
else:
    summary += "모든 세대가 비교적 고르게 분포되어 있어 균형 있는 정책 설계가 요구됩니다."
